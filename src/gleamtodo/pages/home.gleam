import gleam/list
import gleamtodo/models/item.{type Item, Completed, Uncompleted}
...
/// Component for the todos main section.
...
/// Component for the todo input form.
...
/// Create a todo component from an Item.
fn item(item: Item) -> Element(t) {
  // Set completed_class depending on the Item status
...
// Component for empty todo state.
fn todos_empty() -> Element(t) {
  div([class("todos__empty")], [])
}

// Component for the delete svg.
